...
window.STUDY_CONFIG = {
  ...
  epoch: "launch-2026-09-23",   /* change this to discard every browser's saved runs and unsent answers */
  version: "20260922232952"   /* bumped by remote/bump_version.py on each deploy (cache busting) */
};
